    ...
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <section id="features" className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <p className="text-lg text-slate-500 leading-relaxed">AetherMed AI combines clinical intelligence with operational excellence to help you focus on what matters most: your patients.</p>
          </div>
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto bg-brand-600 rounded-[3rem] p-16 relative overflow-hidden text-center">
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            ...
            <p className="text-xl text-brand-100 mb-12">Join thousands of doctors who are already using AetherMed AI to provide better care.</p>
      ...
      <footer className="py-20 bg-white border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-12">
          <div className="col-span-2">
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="font-display font-bold text-xl tracking-tight">AetherMed AI</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 pt-12 mt-12 border-t border-slate-100 flex flex-col md:row justify-between items-center gap-6">
          <p className="text-slate-400 text-sm">© 2026 AetherMed AI. All rights reserved.</p>
